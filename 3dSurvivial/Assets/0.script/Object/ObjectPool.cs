    ...
    public GameObject ObjectCreate()
    {
        if(Objectspool.Count <= 0)
        {
            for (int i = 0; i < 50; i++)
            {
                ...
                GameObject obj2 = Instantiate(objects[1].gameObject, transform);
                obj2.SetActive(false);
                Objectspool.Enqueue(obj2.GetComponent<ObjectClass>());
                ...
                obj3.SetActive(false);
                Objectspool.Enqueue(obj4.GetComponent<ObjectClass>());

                GameObject obj5 = Instantiate(objects[4].gameObject, transform);
                obj3.SetActive(false);
                Objectspool.Enqueue(obj5.GetComponent<ObjectClass>());
            }
